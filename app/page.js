import { ClipboardList, GraduationCap, TrendingUp, Play, Plus, Sparkles, Presentation } from "lucide-react"
...
const data = [
    {title:'Total Classes', content:'2', color:'blue', icon:<Presentation/>}, 
